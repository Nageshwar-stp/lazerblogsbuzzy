...
class UsersController extends UserBaseController
{
    ...
    {
        $lastPost = $this->user->posts()->byActiveTypes();
    ...
    public function draftposts()
    {
        ...
        $lastPost = $this->user->posts()->byActiveTypes()->approve('draft')->latest('published_at')->paginate(15);
    ...
    public function deletedposts()
    {
        ...
        $lastPost = $this->user->posts()->byActiveTypes()->onlyTrashed()->latest('published_at')->paginate(15);
