    ...
    <ul class="sidebar-menu">
        ...
        <li class="treeview  @if(Request::segment(2)=='config') active @endif">
            ...
            <ul class="treeview-menu">
                ...
                <li class="@if(Request::query('q')=='advanced') active @endif"><a
                        href="{{ action('Admin\ConfigController@index', ['q' => 'advanced']) }}"><i
                            class="fa fa-caret-right"></i> {{ trans('admin.AdvancedConfiguration') }}</a></li>
            </ul>
        </li>
