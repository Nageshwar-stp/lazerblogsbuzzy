                ...
                <div class="box-body">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $key+1 }}.</td>
                                <td>{{ $page->title }} <a href="{{ url('/pages/'.$page->slug) }}" target="_blank"
                                        style="margin-left:15px"><i class="fa fa-external-link"></i></a></td>
                                <td>
                                    <a href="pages/edit/{{ $page->id }}" class="btn btn-sm btn-success" role="button"
                                        data-toggle="tooltip" data-original-title="{{ trans('admin.edit') }}"><i
                                            class="fa fa-edit"></i></a>

                                    <a class="btn btn-sm btn-danger permanently"
                                        href="{{ url('admin/pages/delete/'.$page->id) }}" role="button"
