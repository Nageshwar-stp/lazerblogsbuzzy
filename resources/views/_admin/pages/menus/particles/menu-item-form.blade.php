<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            $menu_item->language : request()->query('lang', app()->getLocale()) , [
            "id"=>"changeLanguage",
...
<div class="box">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ csrf_field() }}
            <input type="hidden" name="menu_id" value="{{$menu->id}}">
            <input type="hidden" name="language" value="{{request()->query('lang', app()->getLocale())}}">
            <select class="form-control" name="category_id">
                @foreach(\App\Category::byMain()->byLanguage(request()->query('lang'))->get() as $alt_category)
                <optgroup>
