                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <ul class="products-list product-list-in-box">
                                @foreach(\App\Post::byCategoryRecursively($cat->id)->byPublished()->byApproved()->take(5)->get()
                                as $item)
                        ...
                        <div class="box-footer text-center">
                            <a href="/admin/cat/{!! $cat->name_slug !!}"
                                class="uppercase">{{ trans('admin.viewall') }}</a>
                        </div><!-- /.box-footer -->
                    </div>
                </div>
                @endforeach
                    ...
                    <ul class="users-list clearfix">
                        ...
                        <li style=" width: 20%;">
                            ...
                            <a class="users-list-name" target="_blank"
                                href="/profile/{{ $user->username_slug }}">{{ $user->username }}</a>
        ...
        <section class="col-lg-5 connectedSortable">
                        ...
                        <table class="table no-margin" style="overflow: auto;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($item->type == 'news')
                                        <span class="label  bg-aqua"><i
                                                class="fa fa-file-text"></i>&nbsp;{{ trans('admin.news') }}</span>
                                        @elseif($item->type == 'list')
                                        <span class="label bg-green"><i
                                                class="fa fa-th-list"></i>&nbsp;{{ trans('admin.lists') }}</span>
                                        @elseif($item->type == 'quiz')
                                        <span class="label bg-purple"><i
                                                class="fa fa-th-list"></i>&nbsp;{{ trans('admin.quizzes') }}</span>
                                        @elseif($item->type == 'poll')
                                        <span class="label  bg-yellow"><i
                                                class="fa fa-check-square-o"></i>&nbsp;{{ trans('admin.polls') }}</span>
                                        @elseif($item->type == 'video')
                                        <span class="label  bg-red"><i
                                                class="fa fa-youtube-play"></i>&nbsp;{{ trans('admin.videos') }}</span>
                                        @else
                                        @endif
                                    </td>
                                    <td>
                                        <div class="input-group-btn">
                                            <button type="button" class="btn btn-default dropdown-toggle"
                                                ...
                                                aria-expanded="false">{{ trans('admin.actions') }} <span
                                                    class="fa fa-caret-down"></span> </button>
                                            <ul class="dropdown-menu pull-right">
                                                <li><a
                                                        href="{{ action('Admin\PostsController@approvePost',  ['ids' => $item->id, 'action' => 'yes']) }}">{{ trans('admin.approvePost') }}</a>
                                                </li>
                                                <li class="divider"></li>
                                                <li><a target=_blank
                                                        href="{{  action('PostEditorController@showPostEdit', $item->id) }}">{{ trans('admin.editpost') }}</a>
                                                </li>
                                                <li class="divider"></li>
                                                <li><a class="sendtrash"
                                                        href="{{ action('Admin\PostsController@deletePost',  ['ids' => $item->id, 'action' => 'remove']) }}">{{ trans('admin.sendtrash') }}</a>
                                                </li>
                                                <li><a class="permanently"
                                                        href="{{ action('Admin\PostsController@forceDeletePost', ['ids' => $item->id, 'action' => 'remove']) }}">{{ trans('admin.deletepermanently') }}</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
                    ...
                    <div class="box-tools pull-right">
                        <ul class="nav nav-tabs pull-right" style="border:0">
                            <li class="active"><a href="#news-chart" style="color:#000;border-radius: 5px;"
                                    class="btn btn-box-tool box-line-get" data-type="news"
                                    data-toggle="tab">{{ trans('admin.news') }}</a></li>
                            <li><a href="#lists-chart" style="color:#000;border-radius: 5px;"
                                    class="btn btn-box-tool box-line-get" data-type="lists"
                                    data-toggle="tab">{{ trans('admin.lists') }}</a></li>
                            <li><a href="#quizzes-chart" style="color:#000;border-radius: 5px;"
                                    class="btn btn-box-tool box-line-get" data-type="quizzes"
                                    data-toggle="tab">{{ trans('admin.quizzes') }}</a></li>
                            <li><a href="#polls-chart" style="color:#000;border-radius: 5px;"
                                    class="btn btn-box-tool box-line-get" data-type="polls"
                                    data-toggle="tab">{{ trans('admin.polls') }}</a></li>
                            <li><a href="#videos-chart" style="color:#000;border-radius: 5px;"
                                    class="btn btn-box-tool box-line-get" data-type="videos"
                                    data-toggle="tab">{{ trans('admin.videos') }}</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="box box-info box-solid" style="background: #00c0ef;">
                <div class="box-header">
                    ...
                    <div class="box-tools pull-right">
                        <button class="btn btn-box-tool box-donut-get" data-widget="collapse"><i
