<div class="box">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <a href="https://support.akbilisim.com/docs/buzzy/feed-fetcher" target="_blank"
                class="btn btn-sm btn-success" style="height: 25px;line-height:20px; padding: 2px 5px">
                <i class="fa fa-eye"></i> @lang('v4.see_here_more_info')</a>
        </div>
    </div>
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <select id="post_categories" class="demo-default  mb-2" name="post_categories[]" multiple
                ...
                @foreach (\App\Category::byMain()->byLanguage(request()->get('lang'))
                ->byActive()
                ->byOrder()
                ->get()
                as $ci => $categorys)
        ...
        <div class="form-group">
            ...
            $feed->language : request()->query('lang', app()->getLocale()) , [
        ...
        <div>
            ...
            @if(isset($feed->id))
            <a href="/admin/feeds" class="btn btn-default pull-right">{{ trans('admin.Cancel') }}</a>
            @endif
        </div>
    </div>
    {!! Form::close() !!}
