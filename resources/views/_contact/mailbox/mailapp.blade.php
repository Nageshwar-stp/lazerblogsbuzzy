...
<section class="content">
    <div class="row">
        <div class="col-md-3">
            <a href="/admin/mailbox/new" class="btn btn-primary btn-block margin-bottom"><i class="fa fa-paper-plane"
                    style="margin-right: 5px"></i> {{ trans("buzzycontact.SendNewEmail") }}</a>
                ...
                <div class="box-body no-padding">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="{{ Request::segment(3)==$category->slug ? 'active' : ""}}">
                            <a href="/admin/mailbox/{{ $category->slug }}"><i class="fa fa-{{ $category->icon }}"></i>
                                {{ $category->name }}
                        ...
                        <li class="{{ Request::segment(3)==$category->slug ? 'active' : ""}}"><a
                                href="/admin/mailbox/{{ $category->slug }}"><i class="fa fa-folder"
                                    style="color: {{ $category->description }} !important;"></i> {{ $category->name }}
                            </a>

                            <a style="position: absolute;right:5px;top:5px;padding:3px;border:0" class="btn permanently"
                                href="/admin/mailbox/mailcatdelete/{{ $category->id }}"><i class="fa fa-trash"></i></a>
                        ...
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li><a href="javascript:" class="addcat" data-type="mailprivatecat"><i
                                        class="fa fa-plus"></i> {{ trans("buzzycontact.AddFolder") }}</a></li>
                        </ul>
                    </ul>
                </div><!-- /.box-body -->
            </div><!-- /. box -->
            <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="{{ Request::segment(3)==$category->slug ? 'active' : ""}}"><a
                                href="/admin/mailbox/{{ $category->slug }}"><i class="fa fa-circle-o"
                                    style="color: {{ $category->description }} !important;"></i> {{ $category->name }}
                            </a>

                            <a style="position: absolute;right:5px;top:5px;padding:3px;border:0" class="btn permanently"
                                href="/admin/mailbox/maillabeldelete/{{ $category->id }}"><i
                        ...
                        <li><a href="javascript:" class="addcat" data-type="maillabel"><i class="fa fa-plus"></i>
                                {{ trans("buzzycontact.AddLabel") }}</a></li>
                    </ul>

                </div><!-- /.box-body -->
            </div><!-- /.box --><br>
            <a href="javascript:" data-item="buzzycontact" class="btn btn-block btn-warning  btn-sm "
                data-toggle="modal" data-target="#modalbuzzycontact"><i class="fa fa-cog" style="margin-right:0"></i>
                {{ trans("buzzycontact.Settings") }}</a>
