    ...
    <div class="sidebar--fixed">
        <div class="question-post-side-bar-form">
                ...
                <div class="thumbwrapper">
                    <div class="previewshow" @if (isset($post->thumb)) style="display: block;" @endif>
                        ...
                        <div class="thumbactions">
                            <a class="button button-red deleteimage" data-action="remove" data-target="thumb"><i
            ...
            <div class="cd-form" style="margin-top:20px;">
                ...
                <p class="cd-select icon" style="margin:  0;">
                    <input type="text" id="published_at" class="cd-input"
                        placeholder="{{ trans('v3.publish_immediately') }}"
                        value="{{ isset($post->published_at) ? $post->published_at : null }}" autocomplete="off">
                </p>
            </div>
            ...
            <div class="cd-form" style="margin-top:20px;">
                ...
                <p class="cd-select icon" style="margin:  0;">
                    {!! Form::select('language', get_buzzy_language_list_options(),
                    isset($post->language) ? $post->language : app()->getLocale(),
