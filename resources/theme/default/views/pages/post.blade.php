    ...
    <div class="container">
        <div class="mainside postmainside">
            ...
            <div class="post-content" style="margin-top:7px;background: transparent" itemscope=""
                ...
                <span class="tagy"><a href="{{ action('TagController@index', $tag) }}"><i class="fa fa-tag"></i>
                        {{$tag}}</a></span>
                @endforeach
                @endif
        ...
        <div class="sidebar">
            ...
            <div class="colheader" style="border:0;text-transform: uppercase;">
                <h1>{{ trans('index.today') }} {!! trans('index.top', ['type' => '<span
                        style="color:#d92b2b">'.trans('index.posts').'</span>' ]) !!}</h1>
            </div>
...
@endif
<script async defer
    src="//platform.instagram.com/{{  get_buzzy_config('sitelanguage') > "" ? get_buzzy_config('sitelanguage') : 'en_US' }}/embeds.js">
</script>
